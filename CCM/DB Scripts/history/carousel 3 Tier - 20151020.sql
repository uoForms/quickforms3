...
INSERT INTO FACT_queries (queriesKey, queryLabel, query, deleteFlag) VALUES (12, 'getCcmContentNew', 'select d.level1Label as title, b.level2Label as contentId, a.contentHTML as contentHTML from FACT_ccm a left join LKUP_level1 d on a.level1=d.level1Key left join LKUP_level2 b on a.level2=b.level2Key where a.level1 = ?', 0);
