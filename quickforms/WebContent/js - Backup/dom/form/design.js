...
function(){
	...
	quickforms.design = function(formId){
		...
		myForm.find("[data-role='navbar'] li a").each(function(i,dom){
			...
			var uploadButton = $('<img src="'+quickforms.cssUrl+'quickforms/images/uploadIcon.png" onClick="window.location=\''+
                               'upload.html?app='+quickforms.app+'&filter='+filter+'\'" >');
	...
	window.editOption = function(domId){
        ...
        var uploadButton = $('<a id="uploadCsv" data-role="button" href="upload.html?app='+quickforms.app+'" data-icon="arrow-u" data-theme="c" data-inline="true">Upload</a>');
	...
	function displayEditingPage(data, domId)
	{
		...
		if(isJSONString(data)){
			...
			//Simply commenting out this Save Button instead of deleting for tracing purposes since the backend of this button has not been removed.
