...
public class Pregapp_EmailNotification_Settings {
	...
	public void setSubscriberNotification(String value){
		subscriberNotification = value;
	}
	...
	public Boolean loadFromFile(){
		...
		try{
			...
			File inputFile = new File("C:\\TaskScripts\\Settings\\Pregapp.xml");
	         ...
	         nList = doc.getElementsByTagName("Subscription_Notification");	         
	         if(nList.getLength() > 0){
	        	 this.subscriberNotification = innerXml(nList.item(0)).replace("<?xml version=\"1.0\" encoding=\"UTF-16\"?>", "").trim();
	         }
