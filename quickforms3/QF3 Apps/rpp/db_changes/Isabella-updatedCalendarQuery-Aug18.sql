...
SET @user = ?;                 
SET @block= ?;        
SELECT rppWeekOrder as id, rppWeek, ''newVisit'' as form, [Sunday] AS Sun, [Monday] as Mon, [Tuesday] AS Tue, 
[Wednesday] as Wed, [Thursday] as Thu,   [Friday] as Fri, [Saturday] as Sat     FROM         
...
UNION      
(SELECT rppWeekOrder as id, rppWeek, ''newVisit'' as form, ''0'' as Sun,''0'' as Mon, ''0'' as Tue, ''0'' as Wed, ''0'' as Thu, ''0'' as Fri,   
''0'' as Sat   FROM LKUP_date WHERE block = @block and (NOT (rppWeek IS NULL))    
EXCEPT        
SELECT DISTINCT  LKUP_date.rppWeekOrder, LKUP_date.rppWeek, ''newVisit'' as form, ''0'' as Sun,''0'' as Mon, ''0'' as Tue, 
''0'' as Wed, ''0'' as Thu, ''0'' as Fri, ''0'' as Sat       FROM    FACT_visits 
