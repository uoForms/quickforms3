<%@ page title="PAL-IS | Log in" language="C#" autoeventwireup="true" masterpagefile="~/LoginMaster.master" inherits="TeamPortal.UI.Secure.Login, App_Web_adminlogin.aspx.7a311ea4" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentCenter" runat="Server">
    <h2>
        <asp:Label ID="lblTitle" runat="server" Text="Log in to PAL-IS"></asp:Label></h2>
    <hr />
    ...
    <hr />
    <asp:Image ID="imgHelp1" runat="server" ImageUrl="~/Images/Icons/help.png" ImageAlign="Middle"
        AlternateText=" " />&nbsp;&nbsp;<asp:HyperLink ID="lnkPasswordRecovery" runat="server" NavigateUrl="~/Secure/PasswordRecovery.aspx">Forgot your password?</asp:HyperLink>
</asp:Content>