define([],function(){
	...
	config.vAxis= {title: '% of ER in last 2 Weeks of life', gridlines: {count: 5, color: gridlinesColor},format:0, baselineColor:axisColor, textStyle:{color: axisTitleColor}};
