define([],function(){
	...
	config.height=450,
    config.width= '100%';
	config.title="Training Report";
	config.vAxis= {maxValue: 100};
	config.backgroundColor= backColor;
	config.chartArea={width:"60%",height:"75%"};
	config.hAxis= {title: 'Attendee Facility',textStyle: {color: axisTitleColor}};
	config.vAxis= {title: '# of Attendees', gridlines: {count: 5, color: gridlinesColor},format:0, baselineColor:axisColor, textStyle:{color: axisTitleColor}};
