		...
		$('#patient-button').click(function(){
			$('#patient').change(function(){
				...
				if(document.URL.indexOf('documents.html') >= 0){
					...
					var url = "https://app.klipfolio.com/api/1/datasources/054177c5bfacc0efde5d6071bb734fed/properties";
					var json = "{'properties':{'endpoint_url':'http://quickforms3.eecs.uottawa.ca/quickforms/getResultSet?app=rehab&queryLabel=getSummaryDataForKlipfolio&whereclause=patientsKey="+localStorage.getItem('selected')+"&params='}}"
