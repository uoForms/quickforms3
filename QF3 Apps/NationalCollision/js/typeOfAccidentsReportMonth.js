define([],function(){
	...
	config.hAxis= {title: 'Month', textStyle: {color: axisTitleColor}};
	config.vAxis= {title: '# of Accidents', gridlines: {count: 5, color: gridlinesColor},format:0, baselineColor:axisColor, textStyle:{color: axisTitleColor}};
