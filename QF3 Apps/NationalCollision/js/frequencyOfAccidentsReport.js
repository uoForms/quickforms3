define([],function(){
	var config = {};
	config.title="Frequency of Accidents Report";
	...
	config.hAxis= {title: 'Year', textStyle: {color: axisTitleColor}};
	config.vAxis= {title: 'Frequency of Accidents', gridlines: {count: 5, color: gridlinesColor},format:0, baselineColor:axisColor, textStyle:{color: axisTitleColor}};
