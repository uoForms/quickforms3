define([],function(){
	...
	config.hAxis= {title: 'Facility Sector', textStyle: {color: axisTitleColor}};
	config.vAxis= {title: 'Number of Referrals', gridlines: {count: -1, color: gridlinesColor},format:0, baselineColor:axisColor, textStyle:{color: axisTitleColor}};
