...
function (){
	...
	else
	{
		var header = $('div[data-role="header"]'),
			...
			submitFloatPlanDiv=$('<div class="ui-btn-left" data-role="controlgroup" data-type="horizontal" ></div>')
			submitFloatPlanButton = $('<a href="#" data-role="button" data-theme="c" onclick="" style="position:relative;top:-5px">Submit Float Plan</a>'),
		...
		topLeftContainer.append(submitFloatPlanButton);
